...
void ASpidering_AIController::on_updated(TArray<AActor*> const& updated_actors)
{
...
void ASpidering_AIController::setup_perception_system()
{
	...
	if (hearing_config)
	{
		...
		//add sight configuration component to perception component
		GetPerceptionComponent()->OnPerceptionUpdated.AddDynamic(this, &ASpidering_AIController::on_updated);
